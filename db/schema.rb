...
ActiveRecord::Schema.define(version: 2021_02_10_011654) do

  create_table "check_ins", charset: "latin1", force: :cascade do |t|
  ...
  create_table "shared_locations", charset: "utf8", force: :cascade do |t|
    t.bigint "user_id"
